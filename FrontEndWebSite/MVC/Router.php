...
$controllers = array('pages' => ['home', 'commentstest', 'formsubmit','about' , 'review' ,'donate' ,'error', 'phptest'], 'secureajax' => ['verifymobile', 'resendmobileverification'] ,'ajax' => ['login', 'registervote' ,'createaccount','getresults'] , 'header' => ['std', 'error'] , 'footer' => ['std', 'error'] , 'login' => ['form'] , 'account' => ['verify']);
