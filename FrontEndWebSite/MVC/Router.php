...
$controllers = array('pages' => ['home', 'commentstest', 'error'], 'secureajax' => ['verifymobile', 'resendmobileverification'] ,'ajax' => ['login', 'registervote' ,'createaccount'] , 'header' => ['std', 'error'] , 'footer' => ['std', 'error'] , 'login' => ['form'] , 'account' => ['verify']);
